    ...
    do
    {
        ...
        case 1:
            if (soup.stock > 0)
            {
                ...
                {
                case 0:
                    printf("Customer wants to buy a beer. How much would you charge for a beer?\n");
                    if (scanf("%d", &price) != 1)
                    {
                        price = 0;
                        while (getchar() != '\n')
                    ...
                    else
                    {
                        if (rand() % 100 < 70)
                        {
                            printf("Customer is unhappy but buys a beer.\n");
                            gold += price;
                            soup.stock -= 1;
                        }
                        else
